...
export const seoConfig: Record<RouteKey, SeoMetadata> = {
  ...
  features: {
    ...
    keywords:
      'ProClaw功能, AI进销存, AI Agent, 云商城, 行业插件, 商户管理软件, 开源进销存, 智能经营',
    ogTitle: '功能全景 - ProClaw | AI Agent · 进销存 · 云商城 · 行业插件',
    ogDescription:
      'AI CEO 主控官 + 25+ Agent 自动分工协作。进销存管理、云托管商城、行业插件生态、团队协作。一个软件搞定所有经营场景。',
  },
  useCases: {
    ...
    keywords:
      'ProClaw应用场景, 餐饮管理, 零售进销存, 美业管理, 宠物店管理, 商户经营, 开源软件',
    ogTitle: '应用场景 - ProClaw | 餐饮 · 零售 · 美业 · 宠物',
    ogDescription:
      '覆盖餐饮、零售、美业、宠物等多行业场景。从进销存到 AI 分析，从本地经营到云商城，适配各类商户需求。',
  },
  pricing: {
    ...
    keywords:
      'ProClaw定价, Token计费, 免费进销存, 开源免费, 云商城价格, AI经营成本, ProClaw价格',
  ...
  faq: {
    ...
    keywords:
      'ProClaw常见问题, ProClaw教程, 进销存软件, AI经营, 数据安全, 开源协议, FAQ',
    ogTitle: '常见问题 - ProClaw | 安装 · 使用 · 定价',
    ogDescription:
      'ProClaw 常见问题解答：安装配置、AI 功能、数据安全、云商城搭建、Token 计费。快速上手 ProClaw。',
  },
  changelog: {
    ...
    keywords:
      'ProClaw更新日志, 版本发布, 新功能, 软件更新, 开源项目',
    ogTitle: '发布日志 - ProClaw | 版本更新与功能发布',
    ogDescription:
      'ProClaw 版本发布日志。查看最新功能更新、改进优化和问题修复记录。',
  },
  plugins: {
    ...
    keywords:
      'ProClaw插件, 餐饮插件, 美业插件, 宠物插件, Cloud插件, 行业方案, 功能扩展',
    ogTitle: '插件商店 - ProClaw | 行业插件 · 即装即用 · 无限扩展',
    ogDescription:
      'ProClaw 插件商店：餐饮 POS/KDS、美业预约营销、宠物店管理、Cloud 托管。按需安装，即装即用。',
  },
  pluginDetail: {
    title: '插件详情 - ProClaw 行业工作流插件 | 功能 · 权限 · 版本',
    description:
      '查看 ProClaw 行业工作流插件详情：功能模块、权限声明、版本历史、用户评价。安装行业插件，扩展 ProClaw 能力。',
    keywords:
      'ProClaw插件详情, 行业插件, 工作流插件, 插件功能, 插件权限',
    ogTitle: '插件详情 - ProClaw 行业工作流插件',
    ogDescription:
      '查看 ProClaw 行业工作流插件详情：功能模块、权限声明、版本历史、用户评价。',
  },
  solutionsCatering: {
    ...
    keywords:
      '餐饮管理系统, 餐厅POS软件, 厨房显示系统, KDS, 桌台管理, 餐饮软件, AI餐饮',
    ogTitle: '餐饮经营管理系统 - ProClaw 行业方案',
    ogDescription:
      'ProClaw 餐饮行业方案：POS收银、桌台管理、KDS厨房显示、智能菜单优化。AI驱动的餐厅管理系统。',
  },
  solutionsBeauty: {
    ...
    keywords:
      '美业管理系统, 美容院预约软件, 美发店管理, 员工排班, 会员营销, 美业软件',
  ...
  solutionsPet: {
    ...
    keywords:
      '宠物店管理系统, 宠物寄养软件, 宠物美容预约, 宠物档案管理, 宠物店进销存',
  ...
  solutionsCloud: {
    ...
    keywords:
      '云进销存, Token计费, 数据云备份, 云商城托管, 云端同步, 云服务',
