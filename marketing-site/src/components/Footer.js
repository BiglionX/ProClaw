        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><react_router_dom_1.Link to="/features" className="text-gray-400 hover:text-white text-sm transition-colors">功能全景</react_router_dom_1.Link></li>
              <li><react_router_dom_1.Link to="/use-cases" className="text-gray-400 hover:text-white text-sm transition-colors">应用场景</react_router_dom_1.Link></li>
              <li><react_router_dom_1.Link to="/download#pricing" className="text-gray-400 hover:text-white text-sm transition-colors">定价</react_router_dom_1.Link></li>
              <li><react_router_dom_1.Link to="/download" className="text-gray-400 hover:text-white text-sm transition-colors">下载</react_router_dom_1.Link></li>
              <li><react_router_dom_1.Link to="/flowhub" className="text-gray-400 hover:text-white text-sm transition-colors">FlowHub 插件市场</react_router_dom_1.Link></li>
              <li><react_router_dom_1.Link to="/faq" className="text-gray-400 hover:text-white text-sm transition-colors">常见问题</react_router_dom_1.Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><react_router_dom_1.Link to="/solutions/catering" className="text-gray-400 hover:text-white text-sm transition-colors">餐饮</react_router_dom_1.Link></li>
              <li><react_router_dom_1.Link to="/solutions/beauty" className="text-gray-400 hover:text-white text-sm transition-colors">美业</react_router_dom_1.Link></li>
              <li><react_router_dom_1.Link to="/solutions/pet" className="text-gray-400 hover:text-white text-sm transition-colors">宠物</react_router_dom_1.Link></li>
              <li><react_router_dom_1.Link to="/solutions/cloud" className="text-gray-400 hover:text-white text-sm transition-colors">Cloud 托管</react_router_dom_1.Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><react_router_dom_1.Link to="/changelog" className="text-gray-400 hover:text-white text-sm transition-colors">发布日志</react_router_dom_1.Link></li>
