...
var RouteSEO_1 = require("./RouteSEO");
var SolutionPage = function (_a) {
    var data = _a.data, routeKey = _a.routeKey;
    return (<div className="min-h-screen bg-gray-50 flex flex-col">
      <RouteSEO_1.default routeKey={routeKey}/>
      <Navbar_1.default />

      {/* Hero */}
      <div className={"bg-gradient-to-br ".concat(data.heroGradient, " text-white")}>
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
          ...
          <div className="mt-8">
            <react_router_dom_1.Link to="/download" className="inline-block px-8 py-4 bg-white text-gray-900 font-bold rounded-lg hover:bg-gray-100 transition-all shadow-lg hover:shadow-xl">
              免费下载桌面端
      ...
      <div className="py-16 bg-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {data.painPoints.map(function (item, idx) { return (<div key={idx} className="bg-gray-50 rounded-2xl border border-gray-100 p-6 hover:shadow-md transition-all">
      ...
      <div className="py-16 bg-gray-50">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {data.features.map(function (feature, idx) { return (<div key={idx} className="bg-white rounded-xl border border-gray-100 p-5 hover:border-gray-300 hover:shadow-sm transition-all">
      ...
      <div className="py-16 bg-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {data.aiAgents.map(function (agent, idx) { return (<div key={idx} className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl border border-gray-200 p-6 hover:shadow-md transition-all">
      ...
      <div className="py-16 bg-gray-50">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {data.pricing.map(function (item, idx) { return (<div key={idx} className={"bg-white rounded-2xl border-2 p-6 text-center ".concat(idx === 0 ? 'border-green-300' : idx === 1 ? 'border-gray-200' : 'border-blue-200')}>
      ...
      <div className="bg-gray-900 py-16">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <react_router_dom_1.Link to="/pricing" className="px-8 py-4 border-2 border-gray-600 text-gray-300 hover:border-gray-400 hover:text-white font-medium rounded-lg transition-all">
              查看完整定价
            </react_router_dom_1.Link>
          </div>
        </div>
