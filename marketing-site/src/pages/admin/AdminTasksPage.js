...
var AdminTasksPage = function () {
    ...
    var handleToggleTask = function (id) {
        console.log("\u5207\u6362\u4EFB\u52A1\u72B6\u6001: ".concat(id));
    };
    var handleRunNow = function (id) {
        console.log("\u7ACB\u5373\u6267\u884C\u4EFB\u52A1: ".concat(id));
    };
    var handleViewLogs = function (id) {
        console.log("\u67E5\u770B\u4EFB\u52A1\u65E5\u5FD7: ".concat(id));
    };
    ...
    var avgSuccessRate = tasks.reduce(function (sum, t) { return sum + t.successRate; }, 0) / tasks.length;
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-xl shadow-sm p-4 mb-6">
          <div className="flex items-center space-x-4">
            ...
            <select value={statusFilter} onChange={function (e) { return setStatusFilter(e.target.value); }} className="px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-900 focus:border-transparent outline-none">
        ...
        <div className="space-y-4">
          {filteredTasks.map(function (task) { return (<div key={task.id} className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow">
                  ...
                  <div className="flex items-center">
                    <div className="flex-1 mr-2">
                      <div className="bg-gray-200 rounded-full h-2">
                        <div className={"h-2 rounded-full ".concat(task.successRate >= 95 ? 'bg-green-500' :
                task.successRate >= 80 ? 'bg-yellow-500' : 'bg-red-500')} style={{ width: "".concat(task.successRate, "%") }}></div>
                      </div>
                    </div>
              ...
              <div className="flex items-center justify-between pt-4 border-t">
                ...
                <div className="flex space-x-2">
                  <button onClick={function () { return handleRunNow(task.id); }} className="px-3 py-1.5 text-sm bg-blue-50 text-blue-700 rounded-lg hover:bg-blue-100 transition-colors">
                    立即执行
                  </button>
                  <button onClick={function () { return handleViewLogs(task.id); }} className="px-3 py-1.5 text-sm bg-gray-50 text-gray-700 rounded-lg hover:bg-gray-100 transition-colors">
                    查看日志
                  </button>
                  <button onClick={function () { return handleToggleTask(task.id); }} className={"px-3 py-1.5 text-sm rounded-lg transition-colors ".concat(task.status === 'active'
...
exports.default = AdminTasksPage;
