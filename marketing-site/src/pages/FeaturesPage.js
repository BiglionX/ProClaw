...
var FeaturesPage = function () {
    return (<div className="min-h-screen bg-gray-50 flex flex-col">
      <RouteSEO_1.default routeKey="features"/>
      <Navbar_1.default />

      <PageHeader_1.default title="功能全景" description="一个人管店、管库存、管订单、管客户。AI 帮你记账、分析、出报表，还能一键开网店。来看看 ProClaw 到底能帮你做什么。"/>

      {/* Feature Sections */}
      <div className="flex-grow">
        {features.map(function (feature, idx) { return (<div key={feature.id} id={feature.id} className={"py-16 scroll-mt-20 ".concat(idx % 2 === 0 ? 'bg-white' : 'bg-gray-50')}>
              ...
              <div className="flex items-start gap-8">
                ...
                <div className="flex-1">
                  ...
                  <ul className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    {feature.highlights.map(function (h, i) { return (<li key={i} className="flex items-start gap-2 text-sm text-gray-600">
      ...
      <CTASection_1.default title="先下载用用看，两个版本都免费" description="3 分钟完成安装，CEO Agent 对话引导配置。不满意？卸了就完了，没有任何损失。" primaryButtonText="免费下载桌面端" primaryButtonLink="/download" secondaryButtonText="查看云托管方案" secondaryButtonLink="/pricing"/>
