...
var HomePage = function () {
    return (<div className="min-h-screen bg-gray-50 flex flex-col">
      <RouteSEO_1.default routeKey="home"/>
      <Navbar_1.default />
      ...
      <div className="relative overflow-hidden pt-16 pb-24 bg-gradient-to-br from-gray-50 via-white to-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            '想开网店？跟它说一声就帮你建好',
        ].map(function (item) { return (<li key={item} className="flex items-center gap-2">
              ...
              <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                <react_router_dom_1.Link to="/download" className="px-8 py-4 border border-transparent text-base font-medium rounded-lg text-white bg-red-600 hover:bg-red-700 shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-0.5">
                ...
                <react_router_dom_1.Link to="/solutions/catering" className="px-8 py-4 border-2 border-gray-300 text-base font-medium rounded-lg text-gray-700 bg-white hover:bg-gray-50 hover:border-gray-400 transition-all">
                  看看行业方案
                </react_router_dom_1.Link>
              </div>
              {/* Three Mode Selection Cards */}
              <div className="mt-10 grid grid-cols-1 sm:grid-cols-3 gap-3">
                {modeCards.map(function (mode) { return (<react_router_dom_1.Link key={mode.id} to={mode.link} className={"rounded-xl border-2 p-4 text-left transition-all hover:-translate-y-1 hover:shadow-md ".concat(mode.color)}>
                    <span className={"inline-block px-2 py-0.5 rounded-full text-xs font-semibold mb-2 ".concat(mode.badge)}>
                      {mode.subtitle}
                    </span>
              ...
              <div className="mt-8 flex items-center justify-center md:justify-start gap-6 text-sm text-gray-500">
                <a href="https://github.com/BigLionX/ProClaw" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-gray-700 transition-colors">
                ...
                <a href="https://github.com/BigLionX/ProClaw/releases/latest" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-gray-700 transition-colors">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4"/>
                  </svg>
                  v1.0.0-beta.2
              ...
              <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl p-6 shadow-2xl">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex gap-2">
                    {['/task list', '/context show', '/report'].map(function (cmd) { return (<span key={cmd} className="px-2 py-1 bg-gray-700 rounded text-xs text-gray-400 font-mono">{cmd}</span>); })}
                  </div>
                </div>
              </div>
            </div>
      ...
      <div className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {featureCards.map(function (card) { return (<react_router_dom_1.Link key={card.title} to={card.link} className="group block p-6 bg-gray-50 rounded-2xl border border-gray-100 hover:border-gray-300 hover:shadow-md transition-all hover:-translate-y-1">
                ...
                {card.tags && card.tags.length > 0 && (<div className="flex flex-wrap gap-1.5 mt-3">
                    {card.tags.map(function (tag) { return (<span key={tag} className="px-2 py-0.5 bg-gray-200 text-gray-600 rounded text-xs font-medium">
                        {tag}
                      </span>); })}
                  </div>)}
              </react_router_dom_1.Link>); })}
      ...
      <div className="py-12 bg-gray-50">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {industryLinks.map(function (item) { return (<react_router_dom_1.Link key={item.slug} to={"/solutions/".concat(item.slug)} className="px-6 py-3 bg-white rounded-xl border border-gray-200 text-gray-700 hover:border-red-300 hover:text-red-600 hover:shadow-sm transition-all text-sm font-medium">
      ...
      <div className="py-16 bg-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {testimonialCards.map(function (t, i) { return (<div key={i} className="bg-gray-50 rounded-2xl border border-gray-100 p-6 hover:shadow-md transition-all">
      ...
      <div className="py-16 bg-gray-50">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-wrap justify-center items-center gap-8">
            {['Tauri 2.11', 'React 18', 'Rust', 'TypeScript', 'Supabase', 'LangChain', 'Next.js 16', 'Expo 52'].map(function (tech) { return (<span key={tech} className="px-4 py-2 bg-white rounded-lg text-sm font-medium text-gray-600 shadow-sm border border-gray-100">
                {tech}
              </span>); })}
          </div>
        </div>
      ...
      <div className="py-20 bg-gray-900">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <react_router_dom_1.Link to="/download" className="px-8 py-4 bg-red-600 hover:bg-red-700 text-white font-medium rounded-lg transition-all shadow-lg hover:shadow-xl">
              免费下载桌面端
            </react_router_dom_1.Link>
            <a href="https://cloud.proclaw.com" className="px-8 py-4 border-2 border-cyan-500 text-cyan-400 hover:border-cyan-400 hover:text-cyan-300 font-medium rounded-lg transition-all">
              体验 Cloud 版
            </a>
            <react_router_dom_1.Link to="/solutions/catering" className="px-8 py-4 border-2 border-gray-600 text-gray-300 hover:border-gray-400 hover:text-white font-medium rounded-lg transition-all">
              查看行业方案
            </react_router_dom_1.Link>
          </div>
        </div>
