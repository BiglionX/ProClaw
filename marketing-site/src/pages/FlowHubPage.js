...
function FlowHubPage() {
    var navigate = (0, react_router_dom_1.useNavigate)();
    return (<div className="min-h-screen bg-gray-50">
      <RouteSEO_1.default routeKey="flowhub"/>
        ...
        <div className="max-w-7xl mx-auto px-6 py-20">
          <div className="max-w-3xl">
            ...
            <div className="flex items-center gap-4">
              <button onClick={function () { return navigate('/plugins'); }} className="px-8 py-3 bg-white text-gray-900 rounded-xl font-semibold hover:bg-gray-100 transition-colors shadow-lg">
                浏览插件商店
              </button>
              <button onClick={function () { return navigate('/download'); }} className="px-8 py-3 border border-gray-500 text-gray-200 rounded-xl font-medium hover:bg-white/10 transition-colors">
                下载 ProClaw
              </button>
            </div>
          </div>
      ...
      <section className="max-w-7xl mx-auto px-6 py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {PARTNERS.map(function (item) { return (<div key={item.name} className="bg-white rounded-2xl border border-gray-200 p-6 hover:shadow-lg hover:border-gray-300 transition-all group cursor-pointer" onClick={function () { return navigate('/plugins'); }}>
              <div className="w-14 h-14 rounded-2xl flex items-center justify-center text-3xl mb-4" style={{ backgroundColor: "".concat(item.color, "15") }}>
                {item.icon}
              </div>
      ...
      <section className="bg-white border-t border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-6 py-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {FEATURES.map(function (feature) { return (<div key={feature.title} className="flex gap-4">
      ...
      <section className="max-w-7xl mx-auto px-6 py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {WORKFLOW.map(function (item) { return (<div key={item.step} className="text-center">
        ...
        <div className="max-w-7xl mx-auto px-6 py-20">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex items-center justify-center gap-4">
              <a href="https://github.com/BigLionX/ProClaw/blob/main/docs/API_DOCUMENTATION.md" target="_blank" rel="noopener noreferrer" className="px-8 py-3 bg-white text-gray-900 rounded-xl font-semibold hover:bg-gray-100 transition-colors shadow-lg">
                查看开发文档
              </a>
              <a href="https://github.com/BigLionX/ProClaw" target="_blank" rel="noopener noreferrer" className="px-8 py-3 border border-gray-500 text-gray-200 rounded-xl font-medium hover:bg-white/10 transition-colors">
                GitHub 仓库
              </a>
            </div>
          </div>
      ...
      <section className="bg-gray-900 text-white">
        <div className="max-w-7xl mx-auto px-6 py-16 text-center">
          ...
          <button onClick={function () { return navigate('/download'); }} className="px-10 py-4 bg-indigo-500 text-white rounded-xl font-semibold hover:bg-indigo-400 transition-colors shadow-lg text-lg">
            免费下载 ProClaw
          </button>
        </div>
      </section>
