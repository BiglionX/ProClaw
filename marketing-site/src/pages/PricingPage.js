...
var PricingPage = function () {
    var _a = (0, react_1.useState)('desktop'), billingTab = _a[0], setBillingTab = _a[1];
    return (<div className="min-h-screen bg-gray-50 flex flex-col">
      <RouteSEO_1.default routeKey="pricing"/>
      <Navbar_1.default />

      <PageHeader_1.default title="透明定价" description="桌面端永久免费开源。云托管商城按需订阅，无隐藏费用。"/>

      {/* Billing Tab Switch */}
      <div className="flex justify-center mt-10 mb-6">
        <div className="inline-flex bg-gray-100 rounded-lg p-1">
          <button onClick={function () { return setBillingTab('desktop'); }} className={"px-6 py-2 rounded-md text-sm font-medium transition-all ".concat(billingTab === 'desktop' ? 'bg-white text-black shadow-sm' : 'text-gray-500 hover:text-gray-700')}>
            桌面端
          </button>
          <button onClick={function () { return setBillingTab('cloud'); }} className={"px-6 py-2 rounded-md text-sm font-medium transition-all ".concat(billingTab === 'cloud' ? 'bg-white text-black shadow-sm' : 'text-gray-500 hover:text-gray-700')}>
            云托管商城
          </button>
        </div>
      </div>
      ...
      {/* Desktop Plans */}
      {billingTab === 'desktop' && (<div className="flex-grow pb-16">
      ...
      {billingTab === 'cloud' && (<div className="flex-grow pb-16">
      ...
      <div className="bg-white py-16">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            {faqs.map(function (faq, i) { return (<div key={i} className="border-b border-gray-200 pb-6">
