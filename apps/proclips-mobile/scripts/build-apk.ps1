# Build ProClips release APK locally (Windows)
#
# Usage:
...
Write-Host '==> Build target: ProClips (com.proclips.app)'
...
$dest = Join-Path $outDir ("proclips-mobile-" + (Get-Date -Format 'yyyyMMdd-HHmmss') + '.apk')
