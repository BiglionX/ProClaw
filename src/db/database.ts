...
export class DatabaseService {
  ...
  static async createProduct(
    product: Omit<Product, 'id' | 'created_at' | 'updated_at' | 'sync_status'>
  ): Promise<Product> {
  ...
  static async recordTransaction(
    transaction: Omit<InventoryTransaction, 'id' | 'created_at' | 'sync_status'>
   ...
   * 获取待同步的记录
   */
  static async getPendingSyncRecords(): Promise<
    Array<{ table: string; records: any[] }>
  > {
