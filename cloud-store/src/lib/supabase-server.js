...
exports.createMiddlewareSupabaseClient = createMiddlewareSupabaseClient;
exports.createRouteSupabaseClient = createRouteSupabaseClient;
var ssr_1 = require("@supabase/ssr");
var headers_1 = require("next/headers");
// 强制使用正确的 Supabase URL
var SUPABASE_URL = 'https://ourolpgrntjrtapgaztt.supabase.co';
var SUPABASE_KEY = 'sb_publishable_SQoKN2LQZ2Y15XtZplLoDw_R7KVviPC';
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    cookieStore = _a.sent();
                    return [2 /*return*/, (0, ssr_1.createServerClient)(SUPABASE_URL, SUPABASE_KEY, {
                            cookies: {
                                getAll: function () {
 ...
 */
function createRouteSupabaseClient(request, response) {
    return (0, ssr_1.createServerClient)(SUPABASE_URL, SUPABASE_KEY, {
        cookies: {
            getAll: function () {
                return request.cookies.getAll();
