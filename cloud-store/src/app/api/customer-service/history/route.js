...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var response, supabase, session, tenantId, searchParams, sessionId, customerId, keyword, page, pageSize, from, to, query, _a, data, error, count, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 4:
                    error_1 = _b.sent();
                    console.error('获取聊天历史失败:', error_1);
