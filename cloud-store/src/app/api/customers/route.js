...
var SENSITIVE_FIELDS = (0, encryptedFields_1.getEncryptedFields)('customers');
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    query = supabase
                        .from((0, tenant_1.schemaTable)(schema, 'customers'))
                        .select('*', { count: 'exact' });
                    if (search) {
...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var response, supabase, session, schema, body, encryptedBody, _a, customer, error, decryptedCustomer, error_2;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    response = server_1.NextResponse.next();
                ...
                case 3:
                    ...
                    return [4 /*yield*/, supabase
                            .from((0, tenant_1.schemaTable)(schema, 'customers'))
                            .insert({
                            code: encryptedBody.code || "CUS-".concat(Date.now().toString(36).toUpperCase()),
                            ...
                            customer_type: encryptedBody.customer_type || 'individual',
                            credit_limit: encryptedBody.credit_limit || 0,
                            ...
                            .single()];
                case 4:
                    _a = _b.sent(), customer = _a.data, error = _a.error;
                    if (error)
                        throw error;
                    decryptedCustomer = (0, fieldEncryption_1.decryptFields)(customer, __spreadArray([], SENSITIVE_FIELDS, true));
                    return [2 /*return*/, server_1.NextResponse.json({ data: decryptedCustomer, success: true }, { status: 201 })];
                case 5:
                    error_2 = _b.sent();
...
function PUT(request) {
    return __awaiter(this, void 0, void 0, function () {
        var response, supabase, session, schema, body, id, updateData, encryptedUpdate, _a, customer, error, decryptedCustomer, error_3;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    response = server_1.NextResponse.next();
                ...
                case 3:
                    ...
                    if (!id)
                        return [2 /*return*/, server_1.NextResponse.json({ error: '缺少客户 ID' }, { status: 400 })];
                    ...
                    return [4 /*yield*/, supabase
                            ...
                            customer_type: encryptedUpdate.customer_type || 'individual',
                            credit_limit: encryptedUpdate.credit_limit || 0,
                ...
                case 4:
                    ...
                    if (error)
                        throw error;
                    decryptedCustomer = (0, fieldEncryption_1.decryptFields)(customer, __spreadArray([], SENSITIVE_FIELDS, true));
                    return [2 /*return*/, server_1.NextResponse.json({ data: decryptedCustomer, success: true })];
                case 5:
                    error_3 = _b.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    if (!id)
                        return [2 /*return*/, server_1.NextResponse.json({ error: '缺少客户 ID' }, { status: 400 })];
                    return [4 /*yield*/, supabase.from((0, tenant_1.schemaTable)(schema, 'customers')).delete().eq('id', id)];
                case 3:
                    error = (_a.sent()).error;
                    if (error)
                        throw error;
