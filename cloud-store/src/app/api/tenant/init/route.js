...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var response, supabase, session, userId, success, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, (0, tenant_1.initializeTenantSchema)(userId)];
                case 3:
                    success = _a.sent();
                    if (!success) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: '初始化租户失败' }, { status: 500 })];
                    }
                ...
                case 4:
                    error_1 = _a.sent();
                    console.error('租户初始化 API 错误:', error_1);
