...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var response, supabase, tenantContext, tenant, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    tenant = (_a.sent()).data;
                    if (!tenant) {
                        return [2 /*return*/, server_1.NextResponse.json({ success: false, error: '租户不存在' }, { status: 404 })];
                    }
                ...
                case 4:
                    error_1 = _a.sent();
                    console.error('Get token balance error:', error_1);
                    return [2 /*return*/, server_1.NextResponse.json({ success: false, error: '获取 Token 余额失败' }, { status: 500 })];
