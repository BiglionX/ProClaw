        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    query = supabase
                        .from((0, tenant_1.schemaTable)(schema, 'sales_orders'))
                        .select('*', { count: 'exact' });
                    if (params.search) {
                        query = query.or("so_number.ilike.%".concat(params.search, "%,notes.ilike.%").concat(params.search, "%"));
                    }
                    if (params.status)
                ...
                case 3:
                    ...
                    return [4 /*yield*/, supabase
                            .from((0, tenant_1.schemaTable)(schema, 'sales_order_items'))
                            .select('*')
                ...
                case 5:
                    ...
                    return [2 /*return*/, server_1.NextResponse.json({ data: ordersWithItems, total: count || 0, page: params.page || 1, pageSize: params.pageSize || 20 })];
                case 6:
                    error_1 = _b.sent();
            ...
            switch (_b.label) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, supabase
                            .from((0, tenant_1.schemaTable)(schema, 'sales_orders'))
                            .insert({
                            so_number: body.so_number || "SO-".concat(Date.now().toString(36).toUpperCase()),
                ...
                case 5:
                    ...
                    if (itemsError)
                        throw itemsError;
                    _b.label = 6;
                case 6: return [4 /*yield*/, supabase.rpc('deduct_tokens', { p_user_id: session.user.id, p_tokens: 1 })];
                case 7:
                    _b.sent();
                    return [4 /*yield*/, supabase.from('api_usage_logs').insert({
                            user_id: session.user.id, resource_type: 'product_sync', tokens_used: 1,
                            endpoint: 'POST /api/sales', metadata: { order_id: order_1.id, so_number: order_1.so_number },
                        })];
                case 8:
                    _b.sent();
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    ...
                    if (!id_1)
                        return [2 /*return*/, server_1.NextResponse.json({ error: '缺少销售单 ID' }, { status: 400 })];
                    return [4 /*yield*/, supabase
                            .from((0, tenant_1.schemaTable)(schema, 'sales_orders'))
                            .update({
                ...
                case 4:
                    ...
                    return [4 /*yield*/, supabase.from((0, tenant_1.schemaTable)(schema, 'sales_order_items')).delete().eq('order_id', id_1)];
                case 5:
                    _b.sent();
                    if (!(updateData.items.length > 0)) return [3 /*break*/, 7];
                    itemsToInsert = updateData.items.map(function (item) { return ({
                        order_id: id_1, product_id: item.product_id || null, quantity: item.quantity || 1,
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    if (!id)
                        return [2 /*return*/, server_1.NextResponse.json({ error: '缺少销售单 ID' }, { status: 400 })];
                    return [4 /*yield*/, supabase.from((0, tenant_1.schemaTable)(schema, 'sales_orders')).delete().eq('id', id)];
                case 3:
                    error = (_a.sent()).error;
                    if (error)
                        throw error;
