...
function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var response, supabase, session, schema, contactId, page, pageSize, from, to, _a, data, error, count, sortedData, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    pageSize = 50;
                    if (!contactId) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: '缺少 contactId' }, { status: 400 })];
                    }
                    from = (page - 1) * pageSize;
                    to = from + pageSize - 1;
                    return [4 /*yield*/, supabase
                            .from((0, tenant_1.schemaTable)(schema, 'messages'))
                            .select('*', { count: 'exact' })
                ...
                case 3:
                    ...
                    return [2 /*return*/, server_1.NextResponse.json({ data: sortedData, total: count || 0 })];
                case 4:
                    error_1 = _b.sent();
...
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var response, supabase, session, schema, body, _a, message, error, error_2;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    response = server_1.NextResponse.next();
                ...
                case 3:
                    ...
                    if (!body.contactId || !body.content) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: '缺少必要参数' }, { status: 400 })];
                    }
                    return [4 /*yield*/, supabase
                            .from((0, tenant_1.schemaTable)(schema, 'messages'))
                            .insert({
                ...
                case 4:
                    ...
                    if (error)
                        throw error;
                    return [2 /*return*/, server_1.NextResponse.json({ data: message, success: true }, { status: 201 })];
                case 5:
                    error_2 = _b.sent();
